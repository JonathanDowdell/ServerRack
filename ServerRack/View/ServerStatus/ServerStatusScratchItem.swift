//
//  ServerStatusScratchItem.swift
//  ServerRack
//
//  Created by Mettaworldj on 6/22/22.
//

import SwiftUI

struct ServerStatusScratchItem: View {
    var body: some View {
        GroupBox {
            VStack(spacing: 20) {
                head
...
struct ServerStatusScratchItem_Previews: PreviewProvider {
    static var previews: some View {
        ServerStatusScratchItem()
